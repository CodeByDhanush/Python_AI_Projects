...
class ChatBot:
    ...
    def preload_convarsation(self, conversation_history = None):
        if isinstance(conversation_history, list):
            ...
            self._conversation_history = [
                ...
                self._construct_message('{"text"}: "Sure, I can return the output as a regular JSON object  with the key as `text`. Here is example: {"text": "Your Output}', 'model')
            ]